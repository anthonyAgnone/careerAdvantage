              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <button class="btn btn-danger btn-block no-mb mt-2" id="Reset">
                      <i class="zmdi zmdi-delete"></i> Clear All Filters</button>
                </div>
              </div>
            </div>
          </div>
                    ...
                    <div class="ms-thumbnail-container">
                      <figure class="ms-thumbnail ms-thumbnail-center ms-thumbnail-light">
                        ...
                        <figcaption class="ms-thumbnail-caption text-center">
                          ...
                          <i class="zmdi zmdi-shopping-case"></i> Apply Today</button>
                              </fieldset>
                            </form>
                            <?php if(isset($_SESSION['username'])) { ?>
                              <form action="<?php echo 'job_delete.php?id=' . $job['id']; ?>" method="post">
                                <fieldset>
                                  <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-sm btn-block btn-raised mt-2 no-mb">
                                    <i class="zmdi zmdi-case"></i> Delete</button>
                                </fieldset>
                              </form>
                            <?php } ?>
