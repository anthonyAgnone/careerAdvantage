...
if(is_post_request()) {
  ...
  $admin['last_name'] = isset($_POST['last_name']) ? $_POST['first_name'] : '';
  $admin['email'] = isset($_POST['email']) ? $_POST['first_name'] : '';
  $admin['username'] = isset($_POST['username']) ? $_POST['first_name'] : '';
  $admin['password'] = isset($_POST['password']) ? $_POST['first_name'] : '';
  $admin['confirm_password'] = isset($_POST['confirm_password']) ? $_POST['first_name'] : '';
